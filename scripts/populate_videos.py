...
Ishlatish:
    cd sudqollanma_bot/
    python scripts/populate_videos.py
"""
...
# Video papkalari — ROOT_DIR ga nisbatan aniq yo'llar
VIDEO_SOURCES = [
    {
        "folder":       os.path.join(ROOT_DIR, "data", "jib-sud-uz", "vids"),
        "systemId":     "ESUD",
        "category":     "guide",
        "storage_path": "videos/jib-sud-uz",
    },
    {
        "folder":       os.path.join(ROOT_DIR, "data", "ms-sud-uz", "vids"),
        "systemId":     "MS",
        "category":     "guide",
        "storage_path": "videos/ms-sud-uz",
    },
    {
        "folder":       os.path.join(ROOT_DIR, "data", "xatolik-vids"),
        "systemId":     "ESUD",
